import ColorfulButtonMeta from 'F:/demo/lowcode/your-material-name/lowcode/colorful-button/meta'
import ColorfulInputMeta from 'F:/demo/lowcode/your-material-name/lowcode/colorful-input/meta'
...
function fillRealVersion(meta, packageName = 'react-comps', version = '0.1.0', basicLibraryVersion={"@alifd/next":"1.25.23","@alifd/meet":"2.6.3","antd":"4.17.3"}) {
  if (!meta || !version) {
    return meta;
  }
  const { npm } = meta;
...
if (!execCompile) {
  window.ReactCompsMeta = { components, componentList };
}